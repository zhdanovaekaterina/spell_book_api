...
Для оценки покрытия тестами можно их выполнить локально. Перед этим убедиться, что локально установлены все нужные библиотеки для локальной работы из .docker/local-requirements.txt.
