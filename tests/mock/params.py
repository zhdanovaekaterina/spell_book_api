...
# Мок-данные для связей класса, подкласса, уровня и заклинаний, в формате агрегата  #todo: переписать все тесты на этот формат
params_available_for_class_aggregated = (
    (  # без указания уровня должны вернуться все доступные заклинания
        # для класса
        {
            'alias': 'wizard'
...
# Мок-данные для получения количества и уровней ячеек заклинаний
params_cell_for_class = (
    (  # для первого уровня
        {
            'alias': 'wizard',
            'level': 1,
    ...
    (  # для уровней выше должен быть какой-то прогресс
        {
            'alias': 'wizard',
            'level': 10,
        },
    ...
    (  # для другого типа заклинателя - другие ячейки
        {
            'alias': 'ranger',
            'level': 1,
        },
    ...
    (  # и для уровней выше - тоже другой результат
        {
            'alias': 'ranger',
            'level': 10,
        },
